...
ITERATIONS = 10				# number of times radamsa is called to mutate the seed file
MAX_FILE_SIZE = 1000				# radamsa-generated files larger than this will be discarded
...
#SEED_FILE_PATH = "./LAVA-M_md5sum_mutation_seed.txt"	# path to seed file
FUZZER_DIR_PATH = "/ilab/users/jtd124/fuzzing/AFL/"		# AFL directory
#TARGET_PATH = "./LAVA-M_md5sum"
...
def minimize_corpus(target_path):
    ...
    # minimize files
    minimize_corpus_files(target_path)



def minimize_corpus_files(target_path):
